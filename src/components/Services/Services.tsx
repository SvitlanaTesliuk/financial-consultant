      ...
      <div className={styles.container}>
        <div className={styles.header}>
          ...
          <p className={styles.description}>
            Допомагаю українцям у Чехії розібратися у фінансових
        ...
        <div className={styles.grid}>
          ...
          <Link to="/services/car-insurance" className={styles.card}>
            ...
            <p>
              Допоможу підібрати страхування автомобіля у Чехії.
            </p>
          ...
          <Link to="/services/investments" className={styles.card}>
            ...
            <p>
              Допоможу знайти відповідний варіант для довгострокового планування.
            </p>
